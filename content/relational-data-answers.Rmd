...
Hint: Could you imagine what an overall combined data frame would look like?

It cuts down the information in each data frame. For specific questions, one only needs to use relevant information from one or two tables. A combined data frame would be clumsy and overwhelming for the human brain
to process. Also, a combined data frame takes up more computer memory and slows analysis speed.
...
[Solution
source](https://jrnold.github.io/r4ds-exercise-solutions/relational-data.html#exercise-13.4.4)
